        ...
        return (
          <div style={{
            ...
            <p>
              ...
              <a href="https://github.com/PotentiaMod/desktop/issues" target="_blank" rel="noreferrer">{'open a GitHub issue'}</a>
              {' or '}
              <a href="mailto:crystalfranks18@hotmail.com" target="_blank" rel="noreferrer">{'email us'}</a>
